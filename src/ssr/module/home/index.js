...
function UserCard() {
  ...
  return (
    function htmlString(args){return (`<div class={"line-border-round":1}><div key="backImgCon"${Breaker.getDynamicAttributes(this,"backImgCon",{"light-back":1})}><noscript key="backImg"${Breaker.getDynamicAttributes(this,"backImg","")}><img key="backImg"${Breaker.getDynamicAttributes(this,"backImg","")}/></noscript></div><div><div><div key="profileImgCon"${Breaker.getDynamicAttributes(this,"profileImgCon",{"white-back":1,"line-border-roundx2":1})}><noscript key="profileImg"${Breaker.getDynamicAttributes(this,"profileImg","")}><img key="profileImg"${Breaker.getDynamicAttributes(this,"profileImg","")}/></noscript></div></div><div><div class={"cursor":1,"deep-back-hover":1,"deep-border-hover":1}><svg fill="none" height="18" viewBox="0 0 24 24" width="18"><path d="M12.4906 17.865L16.3555 14.0002H6.25278C5.01076 14.0002 4.00391 15.007 4.00391 16.2491V17.169C4.00391 17.7411 4.18231 18.2989 4.51427 18.7648C5.90203 20.7125 8.08402 21.7757 10.9999 21.9691C10.9958 21.7863 11.016 21.5982 11.0636 21.4078L11.5213 19.5771C11.6833 18.9291 12.0183 18.3373 12.4906 17.865ZM12.0004 2.00488C14.7618 2.00488 17.0004 4.24346 17.0004 7.00488C17.0004 9.76631 14.7618 12.0049 12.0004 12.0049C9.23894 12.0049 7.00036 9.76631 7.00036 7.00488C7.00036 4.24346 9.23894 2.00488 12.0004 2.00488ZM19.0999 12.6695L13.1974 18.5719C12.8533 18.916 12.6092 19.3472 12.4911 19.8194L12.0334 21.6501C11.8344 22.4462 12.5556 23.1674 13.3517 22.9683L15.1824 22.5106C15.6545 22.3926 16.0857 22.1485 16.4299 21.8043L22.3323 15.9019C23.2249 15.0093 23.2249 13.5621 22.3323 12.6695C21.4397 11.7768 19.9925 11.7768 19.0999 12.6695Z" fill="#ffffff"></path></svg><span>Edit</span></div></div></div><div class={"deep-color":1}>${Breaker.getRightValue(xss(args.fullname))}</div><a href="" class={"deep-color-less":1}> @${Breaker.getRightValue(xss(args.username))}</a><div><div><code>${Breaker.getRightValue(args.following)}</code><a href="" class={"color":1}> Following </a></div><div><code>${Breaker.getRightValue(args.followers)}</code><a href="" class={"color":1}> Followers </a></div></div><div>${Breaker.getRightValue(Button({ title: "View profile" }))}</div></div>`)}
  );
}
...
function UserActionsCard() {
  return (
    function htmlString(args){return (`<div class={"line-border-round":1}>${Breaker.getRightValue(UserAction({
            path1:
            ...
            surface: 0,
            width: 23,
          }))}${Breaker.getRightValue(UserAction({
            path1:
...
function UserAction({ path1, path2, surface, width }, attributes, leaveMargin) {
  ...
  return (
    function htmlString(args){return (`<button class={"back-hover":1,"cursor":1,"white-back":1}><div><svg key="svg" id="Layer_1" version="1.1" viewBox="0 0 30 30" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="20" height="20" aria-hidden=true${Breaker.getDynamicAttributes(this,"svg","")}><g><path key="path1"${Breaker.getDynamicAttributes(this,"path1","")}></path></g><path key="path2"${Breaker.getDynamicAttributes(this,"path2","")}></path></svg><span key="name"${Breaker.getDynamicAttributes(this,"name","")}>${Breaker.getRightValue(args.actionname)}</span></div></button>`)}
  );
}
...
function Button() {
  return (
    function htmlString(args){return (`<button key="main"${Breaker.getDynamicAttributes(this,"main",{"cursor":1,"deep-back-hover":1,"deep-border-hover":1})}>${Breaker.getRightValue(args.title)}</button>`)}
  );
}
...
function NavigationLink() {
  return (
    function htmlString(args){return (`<a href="" class={"deep-color":1,"back-hover":1}>${Breaker.getRightValue(args.icon())}<span>${Breaker.getRightValue(args.title)}</span></a>`)}
  );
}
...
function TopicsLink() {
  ...
  return (
    function htmlString(args){return (`<button class={"line-border-bottom":1,"light-hover-less":1,"cursor":1,"transparent":1}><div class={"deep-color-less":1}>${Breaker.getRightValue(xss(args.title))}</div><div><div><div class={"line-border-roundx2":1,"light-back":1}><noscript key="image1" aria-hidden=true${Breaker.getDynamicAttributes(this,"image1","")}><img key="image1" aria-hidden=true${Breaker.getDynamicAttributes(this,"image1","")}/></noscript></div><div class={"line-border-roundx2":1,"light-back":1}><noscript key="image2" aria-hidden=true${Breaker.getDynamicAttributes(this,"image2","")}><img key="image2" aria-hidden=true${Breaker.getDynamicAttributes(this,"image2","")}/></noscript></div><div class={"line-border-roundx2":1,"light-back":1}><noscript key="image3"${Breaker.getDynamicAttributes(this,"image3","")}><img key="image3"${Breaker.getDynamicAttributes(this,"image3","")}/></noscript></div><div aria-hidden=true class={"line-color":1}> and many more </div></div><div>${Breaker.getRightValue(Button({ title: "Follow" }))}</div></div></button>`)}
  );
}
...
function App() {
  return (
    function htmlString(args){return (`<div><div>${Breaker.getRightValue(UserCard({
              username: "KBismark_",
              ...
              followers: 1045,
              following: 2354,
            }))}${Breaker.getRightValue(UserActionsCard())}</div><div><nav class={"line-border-round":1}>${Breaker.getRightValue(NavigationLink({
                title: "Home",
                icon: () => HomeSolid({ size: 28, color: "#302e2d" }),
              }))}${Breaker.getRightValue(NavigationLink({
                title: "Projects",
                ...
                adjust: true,
              }))}<div class={"line-border-top":1}><a href="" class={"page-color":1}> About </a><a href="" class={"page-color":1}> Privacy </a><a href="" class={"page-color":1}> Terms and Conditions </a></div></nav>${Breaker.getRightValue(AccountSuggestion())}${Breaker.getRightValue(TopicsSuggestion())}</div></div>`)}
  );
}
...
function AccountsLink() {
  return (
    function htmlString(args){return (`<div class={"fake-button":1,"line-border-bottom":1,"cursor":1,"light-hover":1,"transparent":1}><div><div><div key="profileImgCon"${Breaker.getDynamicAttributes(this,"profileImgCon",{"light-back":1,"line-border-roundx2":1})}><noscript key="profileImg"${Breaker.getDynamicAttributes(this,"profileImg","")}><img key="profileImg"${Breaker.getDynamicAttributes(this,"profileImg","")}/></noscript></div></div><div><div class={"deep-color":1}>${Breaker.getRightValue(xss(args.fullname))}</div><a href="" class={"deep-color-less":1}> @${Breaker.getRightValue(xss(args.username))}</a></div></div><div>${Breaker.getRightValue(Button({ title: "Follow" }))}</div></div>`)}
  );
}
AccountsLink = createComponent(AccountsLink);
function AccountSuggestion() {
  return (
    function htmlString(args){return (`<div class={"transparent":1}><h2 class={"deep-color":1}> Connect with others </h2>${Breaker.getRightValue(AccountsLink({ fullname: "Bismark Yamoah", username: "KBismark_" }))}${Breaker.getRightValue(AccountsLink({ fullname: "Abigail Twumasi", username: "abi_twum" }))}${Breaker.getRightValue(AccountsLink({
            fullname: "John Turkson Emmanuel",
            username: "jonnie1_uk",
          }))}<a href="" class={"page-color":1}> See more accounts </a></div>`)}
  );
}
...
function TopicsSuggestionSkeleton() {
  return (
    function htmlString(args){return (`<div class={"light-back":1,"line-border-round":1}><h2 class={"deep-color":1}> Topics </h2><div class={"line-border-bottom":1,"cursor":1,"transparent":1}><div></div><div></div></div><div class={"line-border-bottom":1,"cursor":1,"transparent":1}><div></div><div></div></div><div class={"line-border-bottom":1,"cursor":1,"transparent":1}><div></div><div></div></div></div>`)}
  );
}
TopicsSuggestionSkeleton = createComponent(TopicsSuggestionSkeleton);
function TopicsSuggestion() {
  return (
    function htmlString(args){return (`<div class={"light-back":1,"line-border-round":1}><h2 class={"deep-color":1}> Topics </h2>${Breaker.getRightValue(TopicsLink({ title: "Web development" }))}${Breaker.getRightValue(TopicsLink({
            title: "Computer Science and Programming Languages",
          }))}${Breaker.getRightValue(TopicsLink({ title: "Technology and Science" }))}<a href="" class={"page-color":1}> View more topics </a></div>`)}
  );
}
...
function HomeSolid({ size, color }) {
  ...
  return (
    function htmlString(args){return (`<svg version="1.1" viewBox="0 0 24 24" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24" height="24" key="icon"${Breaker.getDynamicAttributes(this,undefined,"")}><g></g><g><path key="path" fill="#302e2d" d="M23.6,10.3L13.2,2.4c-0.7-0.5-1.7-0.5-2.5,0L0.4,10.3C-0.4,10.9,0,12,1,12h1v6.1C2,20.2,3.8,22,6,22h2 c0.6,0,1-0.4,1-1v-4.9C9,15,9.9,14,11,14h2c1.1,0,2,1,2,2.1V21c0,0.5,0.4,1,1,1h2c2.2,0,4-1.8,4-3.9V12h1 C23.9,12,24.3,10.9,23.6,10.3z"${Breaker.getDynamicAttributes(this,"path","")}></path></g></svg>`)}
  );
}
...
function CommonSolids({ size, iconProps, pathProps }) {
  ...
  return (
    function htmlString(args){return (`<svg key="icon" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"${Breaker.getDynamicAttributes(this,"icon","")}><path key="path" fill="#302e2d"${Breaker.getDynamicAttributes(this,"path","")}></path></svg>`)}
  );
}
