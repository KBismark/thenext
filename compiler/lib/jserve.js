/**
 * JServe beta version.
 * JServe runs your app on the server to generate the SSR HTML output.
 */
...
/**
 * A new `Breaker` object is created for every page to render.
 */
function newPage({
  callback,
  data,
  ...
  const JSH = {
      ...
      from: function JSHONInternalImports(src, server_alternate_src) {
        ...
        if (!JSH.exports[server_alternate_src]) {
          if (server_alternate_src.startsWith("/")) {
            ...
            require(server_alternate_src.replace(
              "/",
              path.join(jserve.srcDirectory, "/ssr/")
            ))(JSH);
            dependencyModulePaths.push({
              internal: server_alternate_src.replace(
                "/module/",
                path.join(jserve.srcDirectory, "/ssr/inline_modules/")
              ),
              external: src,
              pathname: server_alternate_src,
            });
            JSH.pathname = currentPathname;
          }
        }
        return (
          JSH.exports[server_alternate_src] ||
          (JSH.exports[server_alternate_src] = {})
        );
      },
      global: {},
      ...
      if (!pageRendered) {
        ...
        if (src.startsWith("/")) {
          if (!JSH.exports[server_alternate_src]) {
            var currentPathname = JSH.pathname;
            JSH.pathname =
              symbolIdentifier + "inAppModuleLoads-" + server_alternate_src;
            require(server_alternate_src.replace(
              "/",
              path.join(jserve.srcDirectory, "/ssr/")
            ))(JSH);
    ...
    await: function wait(secret, cb) {
      if (appCreation.ready || pageRendered) {
        return;
      }
          ...
          var ssrHtml = require(htmlEntryPath)(
            {
              ...
              render: function () {
                var inline_dependencies =
                    `<script id="brk-starter-script">!function(){var at=Breaker.PAGEDATA;Breaker.PAGEDATA=${stringifyValue(
                      data
                    )};` +
                    `var atk=Object.keys(at);for(var z=0;z<atk.length;z++){Breaker.PAGEDATA[atk[z]]=typeof(Breaker.PAGEDATA[atk[z]])=='undefined'?at[atk[z]]:Breaker.PAGEDATA[atk[z]]};` +
                    `${textSeparatorScript};Object.defineProperty(Breaker,'inline_modules',{value:function JSHONInlineModules(){return {`,
                  i;

                for (i = 0; i < dependencyModulePaths.length; i++) {
                  inline_dependencies += `${JSON.stringify(
                    dependencyModulePaths[i].external
                  )}:${require(dependencyModulePaths[i].internal).toString()},`;
                }
                inline_dependencies += `};},writable:false,configurable:false});!${require(jsSSREntryPath).toString()}()}();</script>`;
                return (
                  JSH.ui.render(renderingPage.ref, renderingPage.args)[
                    symbolIdentifier
                  ].value + inline_dependencies
                );
              },
            },
            escape,
    ...
    getDynamicAttributes: function (This, key, classNames) {
      ...
      if (This.elements && This.elements[key]) {
        var atributeString = "",
          atributes = Object.keys(This.elements[key]),
          i;
        var hasClassAttr = atributes.indexOf("class"),
          index;
        var dynamicClassnames = Object.keys(
          This[symbolIdentifier].dynamicClassnames
        );
        if (
          (hasClassAttr > -1 && atributes.splice(hasClassAttr, 1)) ||
          (dynamicClassnames.length && (This.elements[key]["class"] = []))
        ) {
          ...
          atributeString += ` class="${escape(
            This.elements[key]["class"].join(" ")
          )}"`;
        }
        var valueTypes = ["string", "number", "boolean"];
        for (i = 0; i < atributes.length; i++) {
          if (
            valueTypes.indexOf(typeof This.elements[key][atributes[i]]) >= 0
          ) {
            atributeString += ` ${escape(atributes[i])}="${escape(
              This.elements[key][atributes[i]]
            )}"`;
          }
        }
        if (atributes.indexOf("style") >= 0) {
          ...
          if (dynamicInlineStyles.length > 0) {
            ...
            for (i = 0; i < dynamicInlineStyles.length; i++) {
              atributeString += `${dynamicInlineStyles[i]
                .replace(/[A-Z]/g, "-$&")
                .toLowerCase()}:${
                This.elements[key]["style"][dynamicInlineStyles[i]]
              };`;
            }
            atributeString += '"';
          }
    ...
    getRightValue: function (value, ignoreArray) {
      ...
      if (typeof value == "object") {
        if (null == value) {
          if (ignoreArray) {
            return `<noscript class="brk-d-text"></noscript>`;
          }
          return `<i class="brk-d-node" j-type="text"></i><noscript class="brk-d-text"></noscript>`;
        } else if (Array.isArray(value)) {
          if (!ignoreArray) {
            return `<i class="brk-d-node" j-type="list" j-len="${
              value.length
            }"></i>${value.map((v) => this.getRightValue(v, true)).join("")}`;
          } else {
            return `<noscript class="brk-d-text"></noscript>`;
          }
          ...
          return `<i class="brk-d-node" j-type="element"></i>${value[symbolIdentifier].value}`;
        }
      }
      if (ignoreArray) {
        return `<noscript class="brk-d-text">${_In_Escape(
          value + ""
        )}</noscript>`;
      }
      return `<i class="brk-d-node" j-type="text"></i><noscript class="brk-d-text">${_In_Escape(
        value + ""
      )}</noscript>`;
    },
  };
  ...
  function toString(JSHb, jshonObject, args, This_id, num) {
    var s = "<" + (jshonObject.tag | jshonObject.t),
      i;
  ...
  JSH.ui = {
          ...
          var ssrHtml = require(htmlEntryPath)(
            {
              ...
              render: function () {
                ...
                inline_dependencies += `};},writable:false,configurable:false});!${require(jsSSREntryPath).toString()}()}();</script>`;
                return (
                  JSH.ui.render(pageRef, args)[symbolIdentifier].value +
                  inline_dependencies
                );
              },
            },
    ...
    render: function (ref) {
      ...
      if (!created || (created && states[id][symbolIdentifier].refresh)) {
        ...
        states[id][symbolIdentifier].parent =
          parentComponents[parentComponents.length - 1];
        parentComponents.push(id);
        states[id][symbolIdentifier].created = true;
        var htmlStringFunction = componentTypes[
          ref[symbolIdentifier].classType
        ].fn.apply(states[id], args);
        ...
        if (appCreation.ready) {
          ...
          r[symbolIdentifier] = {
            value: states[id][
              symbolIdentifier
            ].renderingData.htmlStringFunction.apply(states[id], args),
          };
          return r;
        }
        return "";
        ...
        if (!appCreation.ready) {
          ...
          if (states[id][symbolIdentifier].renderingData) {
            states[id][symbolIdentifier].renderingData.htmlStringFunction.apply(
              states[id],
              args
            );
          }
    ...
    setAttribute: function (This, key, attrObj) {
      ...
      if (!This[symbolIdentifier].created || appCreation.ready) {
        return;
      }
      if (This.elements && This.elements[key]) {
        This.elements[key] = {
          ...
          if (typeof update != "boolean") {
            ...
            if (newStateKeys.length > currentStatekeys.length) {
              ...
              for (i = 0; i < newStateKeys.length; i++) {
                if (
                  currentstate[newStateKeys[i]] !== stateObject[newStateKeys[i]]
                ) {
                  mustUpdate = true;
                  break;
                }
    ...
    joinSharedState: function joinSharedState(This, stateId, state) {
      ...
      if (sharedStates[stateId]) {
        if (
          sharedStates[stateId].group.indexOf(This[symbolIdentifier].id) < 0
        ) {
    ...
    setSharedState: function (This, stateId, stateObject, update) {
      ...
      if (mustUpdate) {
        ...
        for (i = 0; i < sharedStates[stateId].group.length; i++) {
          ...
          JSH.ui.render(
            states[sharedStates[stateId].group[i]][symbolIdentifier].ref,
            symbolIdentifier
          );
        }
      }
...
function Render(src, cb, data, htmlEntryPath, renderId, insertable) {
  var brk = newPage({
    ...
    jsEntryPath: path.join(jserve.srcDirectory, "/module", src),
    jsSSREntryPath: path.join(jserve.srcDirectory, "/ssr/inline_modules", src),
    renderId: renderId,
    inserts: insertable,
  });
  brk.import.from("/module" + src);
}
...
function stringifyValue(value) {
  ...
  if (valueType == "object") {
    if (Array.isArray(value)) {
      return `{x:function(){function p(s){var f=[String.fromCharCode(60),String.fromCharCode(62)],r="replace";return s[r](/&lt;/g,f[0])[r](/&gt;/g,f[1])};return ${stringifyArray(
        value
      )}}}.x();`;
    } else if (null != value) {
      return `{x:function(){function p(s){var f=[String.fromCharCode(60),String.fromCharCode(62)],r="replace";return s[r](/&lt;/g,f[0])[r](/&gt;/g,f[1])};return ${stringifyObject(
        value
      )}}}.x();`;
    } else {
      return "null";
...
var textSeparatorScript = `!function(){
    var d=document;
    var t=d.getElementsByClassName("brk-d-text");
    if(t){
        function deX(str) {
...
var jserve = (module.exports = {
  ...
  render: function (param0) {
    ...
    if (ssr) {
      ...
      callback(
        null,
        require(compiled_htmlEntryPath)(
          {
            id: "brk-cr-html",
            is_ssr: "",
            render: function () {
              var merger =
                `<script>!function(){var at=Breaker.PAGEDATA;Breaker.PAGEDATA=${stringifyValue(
                  pageData
                )};` +
                `var atk=Object.keys(at);for(var z=0;z<atk.length;z++){Breaker.PAGEDATA[atk[z]]=typeof(Breaker.PAGEDATA[atk[z]])=='undefined'?at[atk[z]]:Breaker.PAGEDATA[atk[z]]};` +
                `}()</script>`;
              return (
                merger +
                `<script id="app-starter-script" src="/module${escape(
                  jsEntryPath
                )}"></script>`
              );
            },
